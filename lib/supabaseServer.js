...
// Server-side Supabase client (for non-authenticated operations)
...
// Pass authenticated supabase client for RLS-protected buckets
export async function uploadFile(bucket, filePath, file, fileBuffer, authenticatedClient = null) {
  try {
    // Use authenticated client if provided, otherwise fall back to server client
    const client = authenticatedClient || supabaseServer;
...
export const FILE_SIZE_LIMITS = {
  ...
  PROFILE_BANNER: 2 * 1024 * 1024 // 2 MB
};
